...
namespace VirtualStore_RP.BLL
{
    public class ProductBLL
    {
        ...
        {
            string sql = string.Format($@"UPDATE product SET name='{product.Name}',description='{product.Description}',value='{product.ProductValue}',stockQuantity='{product.StockQuantify}',photo='{product.Photo}', provider_id='{product.ProviderID}', category_id='{product.CategoryID}';");
            connection.ExecutionSQL(sql);
        }
