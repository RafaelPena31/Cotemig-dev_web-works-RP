...
namespace VirtualStore_RP.BLL
{
    public class AddressBLL
    {
        ...
        {
            string sql = string.Format($@"UPDATE address SET street='{address.Street}', number='{address.Number}', neighborhood='{address.Neighborhood}', city='{address.City}', cep='{address.Cep}';");
            connection.ExecutionSQL(sql);
        }
